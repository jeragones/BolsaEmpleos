    ...
    <form class="registrar" runat="server">
        ...
        <table>
            <tr>
                ...
                <td class="auto-style1"><asp:TextBox class="txt" runat="server" ID="txtNombre" Height="20px" Width="200px" /></td>
                <td><div class="asterisco"> *</div></td>
            </tr>
            <tr>
                <td><asp:Label class="lblRegistrar" runat="server" Text="Cédula Jurídica:" /></td>
                <td class="auto-style1"><asp:TextBox class="txt" runat="server" placeholder="0" ID="txtCedula1" MaxLength="1" Height="20px" Width="15px" />
            ...
            <tr>
                ...
                <td class="auto-style1"><asp:TextBox class="txt" runat="server" placeholder="example@mail.com" ID="txtCorreo" Height="20px" Width="200px" /></td>
                <td><div class="asterisco"> *</div></td>
            </tr>
            <!--<tr>
            ...
            <tr>
                ...
                <td class="auto-style1"><asp:TextBox class="txt" runat="server" placeholder="example.com" ID="txtWeb" Height="20px" Width="200px" /></td>
            </tr>
            <!--<tr>
        ...
        <tr>
            ...
            <td class="auto-style1"><br /><asp:Button class="btn" runat="server" Text="Cancelar" ID="btnCancelar" OnClick="btnCancelar_Click" NavigateUrl="~/Default.aspx" /></td>
        </tr>
        </table>
    </form>
</asp:Content>