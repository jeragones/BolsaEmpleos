...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" Runat="server">
	...
	<div class="slider-wrap">
		...
		<a href="#1" class="cross-link active-thumb"><img src="../Images/img-news/img1-thumb.jpg" class="nav-thumb" alt="temp-thumb" /></a>
		<div id="movers-row">
			<div><a href="#2" class="cross-link"><img src="../Images/img-news/img2-thumb.jpg"  class="nav-thumb" alt="temp-thumb" /></a></div>
			<div><a href="#3" class="cross-link"><img src="../Images/img-news/img3-thumb.jpg"  class="nav-thumb" alt="temp-thumb" /></a></div>
			<div><a href="#4" class="cross-link"><img src="../Images/img-news/img4-thumb.jpg"  class="nav-thumb" alt="temp-thumb" /></a></div>
			<div><a href="#5" class="cross-link"><img src="../Images/img-news/img5-thumb.jpg"  class="nav-thumb" alt="temp-thumb" /></a></div>
			<div><a href="#6" class="cross-link"><img src="../Images/img-news/img6-thumb.jpg"  class="nav-thumb" alt="temp-thumb" /></a></div>
		</div>
